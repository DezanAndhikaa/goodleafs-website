...
class TableList extends Component {
  ...
  handleClickopenEdit = (idcat, idcourier, couriername) => {
    this.setState({
      openEdit: true,
      idorder: idcat,
      idcour: idcourier,
      courname: couriername,
    });
  };
  ...
  getCourier = () => {
    ...
    axios.get(`http://3a78a3e1bf39.ngrok.io/api/Courier`).then((res) => {
      res.data.Data.map((data) => {
        const tmp = {
          courname: data.CourierName,
          idcour: data.IdCourier,
        };
        prod.push(tmp);
      });
      this.setState({
  ...
  assignCourier = (idorder, idcourier) => {
    axios
      .put(`http://3a78a3e1bf39.ngrok.io/api/Order/assign`, {
        IdOrder: idorder,
        IdCourier: idcourier,
      })
      .then((res) => {
  ...
  getpagination = () => {
    let total = [];
    axios
      .get(`http://3a78a3e1bf39.ngrok.io/api/Order?StatusOrder=0`)
      .then((res) => {
        const temp = res.data;
        ...
        <GridContainer>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-slide-description">
                <Autocomplete
                  ...
                  getOptionLabel={(option) => option.courname}
                  style={{ width: 300 }}
            ...
            <DialogActions>
              ...
              <Button
                onClick={() =>
                  this.assignCourier(this.state.idorder, this.state.idcour)
                }
                color="primary"
              >
                Yes
