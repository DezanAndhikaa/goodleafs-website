...
export default function TableList(props) {
  ...
  const [idarticle, setIdarticle] = useState(props.idarticle);
  const [articletitle, setArticletitle] = useState(props.articletitle);
  const [articleauthor, setArticleauthor] = useState(props.articleauthor);
  const [articlebody, setArticlebody] = useState(props.articlebody);
  ...
  const postAxios = () => {
    ...
    file = foto;
    console.log("Pressed");
    bodyFormData.append("Article.IdArticle", props.idarticle);
    bodyFormData.append("Article.ArticleTitle", articletitle);
    bodyFormData.append("Article.ArticleAuthor", props.articleauthor);
  ...
  const handleClick = () => {
    postAxios(articletitle, articlebody, foto);
  };
        ...
        <CardBody>
          <GridItem>
            <TextField
              ...
              label="Article Title"
              fullWidth={true}
              defaultValue={props.articletitle}
              onChange={(e) => {
